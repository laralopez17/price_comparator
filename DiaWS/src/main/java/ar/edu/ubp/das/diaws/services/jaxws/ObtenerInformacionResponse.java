...
@XmlRootElement(name = "ObtenerInformacionResponse", namespace = "http://services.diaws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerInformacionResponse", namespace = "http://services.diaws.das.ubp.edu.ar/")
