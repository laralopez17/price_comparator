...
@XmlRootElement(name = "ObtenerPreciosResponse", namespace = "http://services.Super3.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerPreciosResponse", namespace = "http://services.Super3.das.ubp.edu.ar/")
