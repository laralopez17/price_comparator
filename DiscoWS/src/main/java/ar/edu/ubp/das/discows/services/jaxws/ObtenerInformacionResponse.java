...
@XmlRootElement(name = "ObtenerInformacionResponse", namespace = "http://services.discows.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerInformacionResponse", namespace = "http://services.discows.das.ubp.edu.ar/")
