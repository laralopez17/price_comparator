...
@XmlRootElement(name = "ObtenerInformacionResponse", namespace = "http://services.supermercadosws.das.ubp.edu.ar/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ObtenerInformacionResponse", namespace = "http://services.supermercadosws.das.ubp.edu.ar/")
